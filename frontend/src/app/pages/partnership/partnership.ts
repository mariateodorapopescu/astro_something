...
export class Partnership {
  ...
  calculate(): void {
    if (!this.name1() || !this.date1() || !this.name2() || !this.date2()) {
      this.result.set('Completeaza numele si data nasterii pentru ambele persoane.');
      return;
    }
    // TODO: apel catre backend pentru calculul real de compatibilitate.
    this.result.set(`Compatibilitatea dintre ${this.name1()} si ${this.name2()} se calculeaza...`);
  }
